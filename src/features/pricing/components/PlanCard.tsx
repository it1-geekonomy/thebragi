...
export function PlanCard({
  ...
  const perUserPrice = isAnnual && plan.perUserCostAnnual
    ? plan.perUserCostAnnual
    : plan.perUserCostMonthly || displayPrice;

  const includedUsers = plan.includedUsers || plan.maxUsers || plan.minimumSeats;
  ...
  return (
    <Card
      ...
      className={cn(
        ...
        isCurrentPlan
          ? "border-white/20 bg-white/[0.02] shadow-[0_0_0_1px_rgba(255,255,255,0.1),0_24px_80px_rgba(255,255,255,0.05)]"
